...
| **Architecture ceremony inflation** | Treating private or reversible scope as non-architectural loses real module choices; applying every concern to those choices makes governance costlier than bypassing it. Mandatory up-front classification and state transitions add ceremony; direct scope and authorization constraints preserve the same boundaries. | State And Ownership (scope; authorization; proportionality); Solve Constructively; 5; 6; 8 |
